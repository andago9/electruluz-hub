...
import { Battery, Building2, Home, Leaf, MessageCircle, Sun, TrendingDown } from "lucide-react";
...
export const Route = createFileRoute("/energia-solar")({
	head: () =>
		buildPageHead({
			...
			description:
				"Paneles solares, inversores y baterías. Soluciones de energía solar para hogar y empresa con instalación profesional.",
			path: "/energia-solar",
			image: solarImg,
			breadcrumbs: [
				{ name: "Inicio", path: "/" },
				{ name: "Energía Solar", path: "/energia-solar" },
			],
		}),
	component: Solar,
});
		...
		<>
			<section className="relative overflow-hidden bg-gradient-hero text-white py-24">
				<div className="absolute inset-0 opacity-30">
					<img
						src={solarImg}
						alt="Paneles solares instalados en La Dorada, Caldas"
						width={1600}
						height={900}
				...
				<div className="relative mx-auto max-w-7xl px-4 lg:px-8">
					...
					<p className="mt-6 max-w-2xl text-lg text-white/80">
						Paneles, inversores y baterías de última generación. Instalación profesional, ahorro
						garantizado y respaldo total.
					</p>
					<a
						href={waLink("Hola, me interesa cotizar un sistema de energía solar")}
						target="_blank"
				...
				<div className="mx-auto max-w-7xl px-4 lg:px-8">
					<div className="text-center max-w-2xl mx-auto">
						<h2 className="text-3xl md:text-5xl font-extrabold">
							Beneficios de la <span className="text-gradient-fire">energía solar</span>
						</h2>
						<p className="mt-4 text-muted-foreground text-lg">
							Una inversión inteligente que se paga sola.
						</p>
					</div>
						...
						{[
							{
								i: TrendingDown,
								t: "Ahorro real",
								d: "Reduce tu factura eléctrica hasta en un 95% desde el primer mes.",
							},
							{
								i: Leaf,
								t: "Energía renovable",
								d: "Aporta al planeta usando energía limpia e inagotable del sol.",
							},
							{
								i: Battery,
								t: "Respaldo confiable",
								d: "Sistemas con baterías para tener energía incluso en cortes.",
							},
							{
								i: Home,
								t: "Hogares",
								d: "Soluciones a la medida para casas y conjuntos residenciales.",
							},
							{ i: Building2, t: "Empresas", d: "Sistemas industriales y comerciales escalables." },
							{
								i: Sun,
								t: "Mantenimiento mínimo",
								d: "Sistemas duraderos con vida útil de más de 25 años.",
							},
						].map((x) => (
							<div
								key={x.t}
								className="rounded-2xl border border-border bg-card p-6 shadow-card hover:shadow-glow transition-all"
							>
			...
			<section className="py-16 bg-secondary">
				<div className="mx-auto max-w-5xl px-4 lg:px-8 text-center">
					...
					<p className="mt-3 text-muted-foreground">
						Solicita un estudio gratuito y descubre cuánto puedes ahorrar.
					</p>
					<a
						href={waLink("Hola, quiero un estudio gratuito de energía solar")}
						target="_blank"
						rel="noopener noreferrer"
